...
const CAT_SHAPES: Record<string, Shape[]> = {
  ...
  // тот же знак без круга — так он нарисован у «Не знаю, помогите» в макете
  question: [{ p: "M12 17h.01" }, { p: "M9.1 9a3 3 0 015.8 1c0 2-3 2.5-3 4" }],
  ...
  "faksimile": [{ p: "M4 18c4-1 5-9 8-9s2 6 4 6 2-3 4-3" }],
  "elektronnaya-podpis": [{ p: "M12 3v10" }, { p: "M8 9l4 4 4-4" }, { p: "M5 19h14" }],
  "poligrafiya": [{ p: "M6 9V4h12v5" }, { p: "M6 18H4v-6h16v6h-2" }, { p: "M8 14h8v6H8z" }],
  "otrisovka-po-foto": [{ p: "M4 16l5-5 4 4 3-3 4 4" }, { p: "M4 5h16v14H4z" }],
  "lazernaya-rezka": [{ p: "M12 2v7" }, { p: "M12 15v7" }, { p: "M2 12h7" }, { p: "M15 12h7" }],
  clip: [{ p: "M21 12.5l-8.5 8.5a5 5 0 01-7-7L14 5.5a3.3 3.3 0 014.7 4.7L10.2 18.7a1.7 1.7 0 01-2.4-2.4L15.5 8.6" }],
